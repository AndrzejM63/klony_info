...
from klony.forms import LoginForm, AcersSearchForm, AcersSingleForm, PostForm, ImageForm
from klony.models import Acers, ORIGIN, SHAPES1, FROST_RES, COLORS, Post, Image
...
class AcerSearch( View ):
    def get(self, request):
        form = AcersSearchForm( )  # is it necessary?
        acers = list( )
        acers_obj = Acers.objects.all( )
